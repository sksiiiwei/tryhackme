...
по классике сначала сканим порты (наконец перешла на rustscan и это было лучшим решением) - ничего интересного, все стандартно
...
сам сайт пустой, ничего не кликается, форма с регистрацией на сервер не отправляется(проверила через бурп). пофаззила поддиректории - ничего интересного (у тех, что выдают код 301 при переходе просто редиректят на пустую страницу)

<img width="700" height="180" alt="image" src="https://github.com/user-attachments/assets/845c08b8-5bc9-4ecd-b091-c4d57be75357" />

решила пофаззать сабдомены и - бинго! нам выдало несколько. но админ1 и апи, к сожалению, ничего интересного не выдлают (пробовала пофаззить,  admin1 выдает достаточно много всего, но ничего полезного найти не смогла. из +- полезного - страница логина на ```http://admin1.vulnnet.thm/typo3```. запомним)
