...
overlay 19G 5.9G 12G 34% /   (это специфическая файловая система, которую Docker использует для объединения слоев образа (того самого «пирога», о котором я говорил раньше). Видишь корень (/) на overlay — ты в контейнере.)
```
